...
- repo: https://github.com/shelkesays/safelint
  rev: v2.0.0rc2  # pin to a release (use the GA tag once v2.0.0 ships)
  hooks:
    - id: safelint
...
printing a single error line: `safelint: error: no files linted —
every file pre-commit passed had a grammar that isn't installed — add
