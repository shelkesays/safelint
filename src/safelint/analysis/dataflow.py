...
_ASSIGNMENT_SHAPES = AssignmentShapes(
    fields={_py.ATTRIBUTE: ("attribute", False), _py.SUBSCRIPT: ("subscript", True)},
    patterns=frozenset({_py.PATTERN_LIST, _py.TUPLE_PATTERN, _py.LIST_PATTERN}),
    chains=frozenset({_py.ASSIGNMENT}),
)
