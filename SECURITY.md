...
| Version(s) | Status |
|---|---|
| **2.11.x** (current; framework presets extended with SAFE908/909 + cross-language taint-projection parity) | ✅ Security fixes |
| **2.2.x - 2.10.x** (Rust in 2.2.x-2.4.x; Go in 2.5.x; PHP in 2.6.x; C in 2.7.x; C++ in 2.8.x; framework presets in 2.9.x; multi-path `check` in 2.10.x) | ✅ Security fixes through ~6 months after the next minor lands |
