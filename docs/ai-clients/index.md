...
5. Update this page (the file you're reading) and the [Changelog](../project/changelog.md).

## See also

- [Adding a new AI client](../contributing/adding-an-ai-client.md) — contributor guide for adding a new AI client to the registry
- [README](https://github.com/shelkesays/safelint#readme) — overall safelint documentation
