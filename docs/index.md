...
| **Java** (with **Spring Boot** framework preset) | `.java` | 20 cross-language rules apply; 4 Spring-specific structural rules (`SAFE901-904`) target Spring annotation patterns. Per-framework *defaults* are switchable via [`[tool.safelint.java] framework = "..."`](languages/java.md#framework-presets). |
